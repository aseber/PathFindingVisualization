...
public class CustomPathfind extends Pathfind { // Shitty pathfinding class I used for testing, you can play with the G and H values for interesting results
	
	public CustomPathfind(BoxNode startNode, BoxNode endNode) {
